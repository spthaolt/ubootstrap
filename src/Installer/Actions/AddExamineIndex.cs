    ...
    public class AddExamineIndex : IPackageAction
    {
        ...
        public bool Execute(string packageName, XmlNode xmlData)
        {
            ...
            if (xmlData.HasChildNodes)
            {
                ...
                var examineIndexFile = umbraco.xmlHelper.OpenAsXmlDocument(VirtualPathUtility.ToAbsolute("~/config/ExamineIndex.config"));
                ...
                var indexSetNode = xmlData.SelectSingleNode("./IndexSet");

                // Add the node
                if (examineLuceneIndexSetsNode == null || examineLuceneIndexSetsNode.OwnerDocument == null || indexSetNode == null)
                {
                    return false;
                }
        ...
        public bool Undo(string packageName, XmlNode xmlData)
        {
            ...
            if (xmlData.HasChildNodes)
            {
                ...
                {
                    var indexName = indexSetNode.Attributes["SetName"].Value;
